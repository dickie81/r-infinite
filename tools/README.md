...
| `fermion_dirac_spectral_zeta.py` | Tests the naive "fermion lapse = regularised Dirac spectral zeta on `S^{2n}`" conjecture at Dirac layers 5, 13, 21, 29. **Naive formulation falsified.** | Part IVb (austerity reframing of Clifford absorption open question) |
