...
Gates (all exit-gated; any failure exits 1):
  ...
  g9  the footer census (this script backticked >= 2; the anchored needles "the **98 scripts cited in place** above"
...
PAPER_NEEDLES = [
    ...
    {'g': 'g9', 's': 'the **98 scripts cited in place** above'},
    {'g': 'g9', 's': 'extended by Theorems 1i–1bv:'},
]
