...
g19-g20):
  ...
  V5 -- g16 the two 1ai net-state markers anchored in the paper;
       ...
       g18 the footer census (the script backticked; "79 scripts cited in place"; "Theorems 1i--1bc" -- the census
...
gate("g18 the footer census (advanced with each landing, "
     "disclosed): this script backticked; 79 cited in "
     "place; the range 1i–1bc (advance disclosed; label re-synced "
