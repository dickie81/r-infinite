...
g19-g20):
  ...
  V5 -- g16 the two 1ai net-state markers anchored in the paper;
       ...
       g18 the footer census (the script backticked; "69
       scripts cited in place"; "Theorems 1i--1as" -- the census
...
gate("g18 the footer census (advanced with each landing, "
     "disclosed): this script backticked; 69 cited in "
     "place; the range 1i–1as (advance disclosed; label re-synced "
