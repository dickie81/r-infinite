...
VERIFICATION (10 gates, exit-gated).
  ...
  V5 -- g8 1ar's key sentences anchored by content (the
       ...
       the anchored needles "the **101 scripts cited in place**
       above" and "extended by Theorems 1i–1by:" against the RAW
...
PAPER_NEEDLES = [
    ...
    {'g': 'g10', 's': 'the **101 scripts cited in place** above', 'form': 'ws'},
    {'g': 'g10', 's': 'extended by Theorems 1i–1by:', 'form': 'ws'},
]
