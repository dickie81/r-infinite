...
VERIFICATION (10 gates, exit-gated).
  ...
  V5 -- g8 1ar's key sentences anchored by content (the
       ...
       the anchored needles "the **80 scripts cited in place**
       above" and "extended by Theorems 1i–1bd:" against the RAW
...
ok &= "the **80 scripts cited in place** above" in paper_raw
ok &= "extended by Theorems 1i–1bd:" in paper_raw
