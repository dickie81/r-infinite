...
ok &= abs(par["d3.0"] - 0.22) <= 5e-3 and abs(par["d3.5"]) <= 0.05           # '0.22' (nearest), 'within 0.05'
# round 315 F315-2: the higher parity changes along the ladder at delta = 3.5 -- even k above odd over rungs 2..8, below over 12..26
o35 = shadow["d3.5"]
def _par(lo, hi):
