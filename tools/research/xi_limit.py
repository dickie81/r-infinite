...
def constants_odd():
    ...
    is the endpoint offset of about 4e-13 in every f(ln n) -- the float64 accuracy of the degree-3000 nodes at t = 0, where
    Xi^2 concentrates -- replicated over the prime powers and scaled by 2 c^2, while int Xi^2 is good to 2e-12; the odd
    weight t^2 Xi^2 kills the endpoint, residual 1e-13; rounds 330-331). The even
