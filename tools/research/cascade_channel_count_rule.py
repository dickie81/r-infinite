...
def report_scope() -> None:
    ...
    print("      All four Dirac-anchored selections are rigorous parallels")
    print("      of theta_C; theta_23's P_2 selection is structurally")
    print("      weaker (no interior Dirac layer; relies on cascade")
    print("      continuity through Majorana stretches plus the d_1")
    print("      phase transition's chirality basin selection).")
    print()
    print("WHAT REMAINS OPEN:")
    print()
    print("  (1) Tightening the theta_23 P_2 identification: a fully rigorous")
    print("      derivation of w_2 = + at d=18 (the (w_2) residue layer in")
    print("      P_2) without leaning on cascade continuity through Majorana")
    print("      stretches.  Candidate: a direct cascade-action computation")
    print("      showing the d=18 spin lift is forced by the d_1 phase")
    print("      transition's effect on the path-integral measure.")
    print()
    print("  (2) Formal proof that the cascade path-integral is exhausted")
    ...
    print("      channel count.")
    print()
    print("  (3) Test: if a future Amplitude observable's descent path spans")
...
def main() -> int:
    ...
    print("        Step 4(1) (theta_23 P_2 rigour), 4(2) (formal completeness),")
    print("        4(3) (PMNS test) remain open.")
