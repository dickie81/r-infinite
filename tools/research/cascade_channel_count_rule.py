...
def report_scope() -> None:
    ...
    print()
    print("WHAT REMAINS OPEN (just one item, falsifier-level):")
    print()
    print("  (1) Test: if a future Amplitude observable's descent path spans")
    ...
    print()
    print("  Previous open items:")
    print("    - 'theta_23 P_2 rigour' CLOSED by cascade_channel_count_p2_rigour.py")
    print("      (original framing inverted; P_2 is one of the two most directly")
    print("      anchored cases).")
    print("    - 'Formal completeness proof' CLOSED by")
    print("      cascade_channel_count_completeness.py (cascade scalar action's")
    print("      Z_2-only discrete symmetry group + Adams' theorem on im J's")
    print("      Z_2 residues + activation criterion).  Higher cyclic groups")
    print("      Z_{24}, Z_{240} at residues 3, 7 mod 8 don't activate as")
    print("      multiplicities; they contribute integer Pontryagin data to")
    print("      source strength (roadmap #3) and sign (roadmap #4) instead.")
    print()
...
def main() -> int:
    ...
    print("        Channel-count rule is now a CASCADE THEOREM:")
    print("          - Activation: cascade scalar action sector-symmetric (Step 2).")
    print("          - Identification: 5/5 period-by-period (+, +) selections (Step 3).")
    print("          - Anchoring: 2/5 DIRECT, 3/5 INHERITED, all reduce to global")
    print("                       cascade conventions (cascade_channel_count_p2_rigour.py).")
    print("          - Completeness: chirality factor exactly chi^(2N), no higher-order")
    print("                          contributions (cascade_channel_count_completeness.py).")
    print("        Only PMNS test remains as falsifier (Step 4).")
