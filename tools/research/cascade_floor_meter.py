...
Gates (all exit-gated; any failure exits 1):
  ...
  g11 the footer census (this script backticked >= 2; the anchored needles "the **99 scripts cited in place** above"
...
PAPER_NEEDLES = [
    ...
    {'g': 'g11', 's': 'the **99 scripts cited in place** above'},
    {'g': 'g11', 's': 'extended by Theorems 1i–1bw:'},
]
