...
VERIFICATION (13 gates, exit-gated; --full extends the census).
  ...
  V5 -- g10 1an's key sentences + the 1aj net-state marker anchored
       ...
       g13 the footer census (this script backticked; "75 scripts
       cited in place"; "Theorems 1i-1ay" -- the census advances
...
gate("g13 the footer census (advanced at the 1an-1ap landings, "
     "disclosed): this script backticked; 75 cited in place; the "
     "range 1i–1ay (label re-synced rounds 167 F6, 175 F2)", ok)
