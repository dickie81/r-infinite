...
spacings gives ghat(gamma) = A sin(pi d), ghat(mid) = A cos(pi d)), is not lifted uniformly (the lift per rung the mean of ln A_k^2/A_1^2 over a window's zeros): in the leakage's units (the lift
