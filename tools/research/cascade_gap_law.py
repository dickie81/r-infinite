...
(1.7 nats rms); that whole is the leakage-weighted mean of the near quarter [T_1, 1.25 T_1), which alone reads a wall 2.8% below
T_w on average (rms 4.7%), and the field beyond, which alone reads one 1.2% above (rms 1.5%), the near reading the higher at 39 of 40. The envelope itself, read by the estimator A(gamma)^2 = ghat(gamma)^2 + ghat(mid)^2 (a zero displaced by d
...
PAPER_NEEDLES = [
    ...
    {'g': 'g6', 's': 'the near quarter [T₁, 1.25T₁) alone reads +0.39 ± 0.47 nats, a wall 2.8% below T_w on average (rms deviation 4.7%), and the field beyond −0.20 ± 0.25, a wall 1.2% above (rms 1.5%), the near reading the higher at 39 of the 40 rungs', 'form': 'ws'},
    {'g': 'g6', 's': 'that constant minus the envelope lift over the ground state’s runs +0.34 ± 0.48 nats on [T₁, 1.25T₁), −0.16 ± 0.32 on [1.25T₁, 1.5T₁) and −0.18 ± 0.26 on [1.5T₁, 2T₁) (means and rms over the 40 rungs)', 'form': 'ws'},
...
S_WIN = 'the near quarter [T₁, 1.25T₁) alone reads +0.39 ± 0.47 nats, a wall 2.8% below T_w on average (rms deviation 4.7%), and the field beyond −0.20 ± 0.25, a wall 1.2% above (rms 1.5%), the near reading the higher at 39 of the 40 rungs'
S_LIFT = 'that constant minus the envelope lift over the ground state’s runs +0.34 ± 0.48 nats on [T₁, 1.25T₁), −0.16 ± 0.32 on [1.25T₁, 1.5T₁) and −0.18 ± 0.26 on [1.5T₁, 2T₁) (means and rms over the 40 rungs)'
...
ok &= paper_needles.needle(PAPER_NEEDLES, 'the near quarter [T₁, 1.25T₁) alone reads +0.39 ± 0.47 nats, a wall 2.8% below T_w on average (rms deviation 4.7%), and the field beyond −0.20 ± 0.25, a wall 1.2% above (rms 1.5%), the near reading the higher at 39 of the 40 rungs', 'ws')
ok &= paper_needles.needle(PAPER_NEEDLES, 'that constant minus the envelope lift over the ground state’s runs +0.34 ± 0.48 nats on [T₁, 1.25T₁), −0.16 ± 0.32 on [1.25T₁, 1.5T₁) and −0.18 ± 0.26 on [1.5T₁, 2T₁) (means and rms over the 40 rungs)', 'ws')
