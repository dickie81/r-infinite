...
(1.7 nats rms); that whole reading's exponential is the rung-leakage-weighted mean of its two parts' (the mediant of the two window
ratios of the ground's share to the rung's), so it lies between them at every rung: the near quarter [T_1, 1.25 T_1) alone reads a
...
spacings gives ghat(gamma) = A sin(pi d), ghat(mid) = A cos(pi d)), is not lifted uniformly: in the leakage's units (the lift
