...
Gates (all exit-gated; any failure exits 1):
  ...
  g10 the footer census (this script backticked >= 2; the anchored needles "the **100 scripts cited in place** above"
...
PAPER_NEEDLES = [
    ...
    {'g': 'g10', 's': 'the **100 scripts cited in place** above'},
    {'g': 'g10', 's': 'extended by Theorems 1i–1bx:'},
]
