...
round-167 rebuild and the 168-173 needle advances).
  ...
  V3 -- g8 the regrade strikes (frames 2 + 2; the CONTRAST
       ...
       "81 scripts cited in place"; "Theorems 1i-1be").
...
ok &= "81 scripts cited in place" in paper
ok &= "Theorems 1i–1be" in paper
gate("g12 the footer census (advanced at this landing, disclosed): "
     "this script backticked; 81 cited in place; the range 1i–1be "
