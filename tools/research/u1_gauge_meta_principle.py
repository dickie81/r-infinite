...
def main() -> int:
    ...
    print()
    print("SCOPE NOTE:")
    print("  The 'meta-principle' invoked here -- 'cascade primitives cannot")
    print("  single out a strict subgroup of their own automorphism group without")
    print("  introducing a free parameter' -- is NOT a separate principle.  It is")
    print("  zero-free-parameters (F1) applied to the gauge-group selection.")
    print("  Specifying Z_2 = {1, -1} subset U(1) is data not derivable from")
    print("  cascade primitives (V1-V4); accepting it as gauge therefore violates")
    print("  F1.  The argument is unconditional given the cascade's defining")
    print("  zero-free-parameters commitment.  An adversary who rejects F1 has")
    print("  rejected the cascade itself, not just this lemma.")
    print()
    print("  The earlier 'Categoricity Lemma' attempt failed because it argued")
    print("  for U(1) at the wrong level (morphism C-linearity, contradicted by")
    print("  the cascade's R-linear slicing primitive).  Targeted at gauge-group")
    print("  selection, foundational closure plus U(1)-invariance of slicing")
    print("  closes the OQ.")
    return 0
