...
PAPER_NEEDLES = [
    ...
    {'g': 'g6', 's': 'the identity holds within 4.4 × 10⁻⁶ of the tail at the five ground states over the five windows (3.3 × 10⁻¹¹ away from the cut at the edge, where the dodged zeros the cut still weighs carry the stored profile’s rounding) and within 2.7 × 10⁻¹¹ at the 40 rungs', 'form': 'ws'},
...
S_ID = 'the identity holds within 4.4 × 10⁻⁶ of the tail at the five ground states over the five windows (3.3 × 10⁻¹¹ away from the cut at the edge, where the dodged zeros the cut still weighs carry the stored profile’s rounding) and within 2.7 × 10⁻¹¹ at the 40 rungs'
...
ok &= paper_needles.needle(PAPER_NEEDLES, 'the identity holds within 4.4 × 10⁻⁶ of the tail at the five ground states over the five windows (3.3 × 10⁻¹¹ away from the cut at the edge, where the dodged zeros the cut still weighs carry the stored profile’s rounding) and within 2.7 × 10⁻¹¹ at the 40 rungs', 'ws')
...
def _sci(s):   # a × 10^b with superscript digits -> float
    ...
    return float(m.group(1))*10**int(e)
