...
(T^s's lower side and T_u at the states): min F_k = F_k^s(T^s) + Osc_inf + O(ln T/sqrt T); |T_u - T^s| = O(T^{1/4} (ln T)^{1/2}); the rung's exponent from the smooth count and the holes
