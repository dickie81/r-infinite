...
VERIFICATION (12 gates, exit-gated).
  ...
  V5 -- g9 the honest partials retained in the paper (the
       ...
       (this script backticked; "73 scripts cited in place";
       "Theorems 1i-1aw" -- the census advances with each landing
...
gate("g12 the footer census (advanced at the 1an-1ap landings, "
     "disclosed): this script backticked; 73 cited in place; the "
     "range 1i–1aw (label re-synced rounds 167 F6, 175 F2)", ok)
