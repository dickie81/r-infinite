...
VERIFICATION (12 gates, exit-gated).
  ...
  V5 -- g9 the honest partials retained in the paper (the
       ...
       (this script backticked; "102 scripts cited in place";
       "Theorems 1i–1bz" -- the census advances with each landing
...
PAPER_NEEDLES = [
    {'s': '102 scripts cited in place', 'form': 'plain', 'min': 1},
    {'s': 'The ladder is generated by the single constant Γ(½)', 'form': 'plain', 'min': 1},
    {'s': 'Theorems 1i–1bz', 'form': 'plain', 'min': 1},
...
ok &= paper_needles.needle(PAPER_NEEDLES, '102 scripts cited in place', 'plain')
ok &= paper_needles.needle(PAPER_NEEDLES, 'Theorems 1i–1bz', 'plain')
