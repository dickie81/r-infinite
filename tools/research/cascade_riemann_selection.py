...
VERIFICATION (12 gates, exit-gated).
  ...
  V5 -- g9 the honest partials retained in the paper (the
       ...
       (this script backticked; "97 scripts cited in place";
       "Theorems 1i–1bu" -- the census advances with each landing
...
PAPER_NEEDLES = [
    {'s': '97 scripts cited in place', 'form': 'plain', 'min': 1},
    {'s': 'The ladder is generated by the single constant Γ(½)', 'form': 'plain', 'min': 1},
    {'s': 'Theorems 1i–1bu', 'form': 'plain', 'min': 1},
...
ok &= paper_needles.needle(PAPER_NEEDLES, '97 scripts cited in place', 'plain')
ok &= paper_needles.needle(PAPER_NEEDLES, 'Theorems 1i–1bu', 'plain')
