...
Gates (all exit-gated; any failure exits 1):
  ...
  g15 the footer census (this script backticked >= 2; the anchored needles "the **85 scripts cited in place** above"
...
gate("g15 the footer census (this script backticked >= 2; 85 cited in place; "
     "the range 1i–1bi)", ok)
