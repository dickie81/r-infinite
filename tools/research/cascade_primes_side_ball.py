...
Gates (all exit-gated; any failure exits 1):
  ...
  g15 the footer census (this script backticked >= 2; the anchored needles "the **103 scripts cited in place** above"
...
PAPER_NEEDLES = [
    ...
    {'g': 'g15', 's': 'the **103 scripts cited in place** above'},
    {'g': 'g15', 's': 'extended by Theorems 1i–1ca:'},
