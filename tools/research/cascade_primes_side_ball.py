...
Gates (all exit-gated; any failure exits 1):
  ...
  g15 the footer census (this script backticked >= 2; "69 scripts cited
      in place"; "Theorems 1i-1as").
...
gate("g15 the footer census (this script backticked >= 2; 69 cited in place; "
     "the range 1i–1as)", ok)
