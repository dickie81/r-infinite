...
def check_invisibility_claim():
    ...
    print(f"  (round 154 F1 -- this script's A250-commit text said 'the")
    print(f"  repaired formula gives 564 eV at leading order'; quote")
    print(f"  fidelity fixed round 155 F1 -- an observed-inputs")
    print(f"  artifact).  m_e/289 = 1768 eV is the")
