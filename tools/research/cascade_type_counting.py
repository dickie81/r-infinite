...
Gates (twelve):
  ...
  V5 -- g9 1al's key sentences anchored; g10 the two net-state
       ...
       footer census (the new script backticked; "62 scripts
       cited in place"; "Theorems 1i–1al"); g12 the two Weil-arc
...
gate("g11 the footer census: the new script backticked; 62 cited in "
     "place; the range 1i–1al", ok)
ok = True
