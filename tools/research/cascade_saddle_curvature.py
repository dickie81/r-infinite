...
Gates (all exit-gated; any failure exits 1):
  ...
  g8  the footer census (this script backticked >= 2; the anchored needles "the **101 scripts cited in place** above"
...
PAPER_NEEDLES = [
    ...
    {'g': 'g8', 's': 'the **101 scripts cited in place** above'},
    {'g': 'g8', 's': 'extended by Theorems 1i–1by:'},
]
