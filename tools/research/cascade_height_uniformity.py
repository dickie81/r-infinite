...
PAPER_NEEDLES = [
    {'g': 'g12', 's': 'Theorem 1bh (the height-uniformity arc', 'form': 'plain'},
    {'g': 'g12', 's': 'the aperture dial', 'form': 'plain'},
    {'g': 'g12', 's': 'out-of-sample at every other aperture', 'form': 'plain'},
    {'g': 'g12', 's': 'the race curve is flat', 'form': 'plain'},
    {'g': 'g12', 's': 'the pole rule', 'form': 'plain'},
    ...
    {'s': 'the **102 scripts cited in place** above', 'form': 'ws', 'g': 'g12'},
    {'s': 'extended by Theorems 1i–1bz:', 'form': 'ws', 'g': 'g12'},
]
...
gate("g12 the 1bh paper needles and the footer census "
