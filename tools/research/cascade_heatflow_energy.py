...
Gates (all exit-gated; any failure exits 1):
  ...
  g7  the footer census (this script backticked >= 2; "77 scripts cited in place"; "Theorems 1i-1ba").
...
gate("g7 the footer census (this script backticked >= 2; 77 cited in place; "
     "the range 1i–1ba)", ok)
