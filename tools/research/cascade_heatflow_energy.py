...
Gates (all exit-gated; any failure exits 1):
  ...
  g7  the footer census (this script backticked >= 2; the anchored needles "the **91 scripts cited in place** above"
...
PAPER_NEEDLES = [
    ...
    {"g": "g7", "s": "the **91 scripts cited in place** above"},
    {"g": "g7", "s": "extended by Theorems 1i\u20131bo:"},
]
