"""Assemble M = beta I + 2 p p^T + C (leading N even Legendre modes of Zhu's reduced form R at L = 1),
...
import sys, pickle, math, json, time
import numpy as np
...
out = {"parity": ["even", "odd"][par], "L": 1, "Tsharp": TS, "N": N, "n0": n0, "beta": beta.str(15), "K_Psi": KP.str(8), "qerr_entry": qerr.str(4),
