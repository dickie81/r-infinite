...
run WindowForm; lake env lean $HERE/src/WindowForm.lean
...
run OddPositivity; HERE="$HERE" lake env bash -c 'LEAN_PATH="$LEAN_PATH:$HERE/build" lean $HERE/src/OddPositivity.lean'
