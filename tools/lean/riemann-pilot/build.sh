...
run TheoremC; HERE="$HERE" lake env bash -c 'LEAN_PATH="$LEAN_PATH:$HERE/build" lean $HERE/src/TheoremC.lean'
run DimTwo; HERE="$HERE" lake env bash -c 'LEAN_PATH="$LEAN_PATH:$HERE/build" lean -R $HERE/src -o $HERE/build/DimTwo.olean -i $HERE/build/DimTwo.ilean $HERE/src/DimTwo.lean'
run HurwitzCount; HERE="$HERE" lake env bash -c 'LEAN_PATH="$LEAN_PATH:$HERE/build" lean $HERE/src/HurwitzCount.lean'
