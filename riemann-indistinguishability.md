...
windows at heights 127, 933, and 2536, a factor ~20 (gated g1/g2,
...
(6.3×10⁻⁸) with dm/m = 0.01% and the null cancellation
PRIME/ARCH = −1 to four digits (gated g9): the 1bg closure and
...
and a negative value at any window disproves RH. Single-height
spot-checks are cheap and the flat race curve says the
sensitivity does not degrade; *sweeping* a height range
