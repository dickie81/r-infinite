...
certificate: even δ = log 2, 0.8, 0.9, 0.95 and odd δ = 0.9,
1.05, 1.09, with 1.09/log 3 = 99.2% of the odd one-prime window.
*(iii) The two-sided machine.* Lower bounds by the Kato–Temple
ratio form λ₁ ≥ (ℓ₂M − S)/(ℓ₂n − M) on frozen pure-harmonic
...
compressed resolvent's eigenvalue count at ν, composite-Simpson
frames with an explicit operator-error budget, verified
eigenvalue enclosures); the odd sector two-stage (the pole-free
Temple bound ν₁ ≤ λ₁, then negative-rank-one interlacing
λ₂ ≥ ν₁). The certified margins: Temple ≥ 1.2947×10⁻³ (even
log 2), 1.6888×10⁻⁴ (0.8), 1.0091×10⁻⁵ (0.9), 7.3568×10⁻⁷
(0.95); odd ≥ 1.3730×10⁻³ (0.9), 2.2583×10⁻⁵ (1.05),
4.8521×10⁻⁶ (1.09); count margins 2.436×10⁻¹ down to
2.058×10⁻⁴ across the eight rows. *(iv) The arithmetic.*
...
signed integrands — a defect self-caught in review and repaired
before certification); the whole chain re-certified
value-identically across four key rotations. *(v) The
...
outright (Yoshida's localization); the certificates are
...
but the Temple side never closed, in float or intervals: the
