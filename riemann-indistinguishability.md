...
odd sector at support length 1.10, λ₁ ≥ 6.3136e-06, every ingredient
...
at the log 3 threshold does not vanish**: λ₁(log 3) ≥ 6.3136e-06 in
...
pole-free λ₁ ≈ 0.015, below what any entire trial can use at this
cell): the certified row (ν, β) = (0.05, 2.0) on 4,616 nodes over
a support of length 87.0 to r = 435 (tail lemma at rmax = 600),
μ₂ ∈ [1.990865, 1.990867], operator-error bound 7.92×10⁻⁵, margin
9.054×10⁻³. The Temple side single-stage at ℓ₂ = ν*: the frozen
...
envelope) — with n, M, S interval enclosures: ρ ∈ [1.4351e-05, 1.4395e-05], σ² ≤
4.017e-07, Temple ≥ 6.3136e-06. *(iv) The arithmetic.* As Theorem 1bj(iv),
...
float against 6.3136e-06 certified). *(vi) Prior art and honest
