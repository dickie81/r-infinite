...
**Scope.** The round-322 sweep commit (the block's D-at-the-cells sentence with the dodging displacements, ε from the located zeros, the parity restricted to the balanced cells with standard errors, the unlocated root's reality argued and its |τ| corrected; the producer at round 6 — Richardson κ, the displacement census, the dip count — with its seven checkpoints recomputed; the verifier's gates and needles; manifest 30). Full-tower class. Brief `brief_round323.md`.
