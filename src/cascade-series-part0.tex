...
as $\Gamma_{\mathbb{R}}$ entire, the global meromorphic function
with its functional-equation role, carrying mirror coherence as its
non-degeneracy clause --- and the labelling $(7,19,217)$ is thereby
forced, with the variational characterisation's output and all the
reformulations above following as corollaries. The cost is recorded
