...
local form, (iii) reads: the infimum's twist points are the poles of
...
the variational definition and all the reformulations above as
corollaries. That principle is adopted, not derived: the open
