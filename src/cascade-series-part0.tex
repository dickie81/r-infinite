...
% for the full commentary). Part 0 has cross-paper prose refs but no
...
(Part~IVb, Corollary~\xref{paperIVb}{cor:2sqrtpi-primitive}) is a \emph{product} of the primitive
