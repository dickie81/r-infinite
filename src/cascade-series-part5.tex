...
The cosmological constant $\Lambda = I = 1.0990 \times 10^{-120}$ (in cascade units) was
...
\begin{proof}
$I = 1.0990 \times 10^{-120}$, $\Omega_\Lambda = (\pi-1)/\pi = 0.68169$, $N(4) = 3\pi/8$,
...
Bott partition of [4] and Corollary~3.2 of [1] (Theorem~\ref{thm:omega_bott}).
