...
\xrhyperdoc{paper1}{cascade-series-part1}
...
satisfies (Part~0~\cite{paper0}, overlap deficit theorem):
\[
...
$G_{\mu\nu} + \Lambda g_{\mu\nu} = 8\pi G\,T_{\mu\nu}$ is the unique
gravitational equation at $d = 4$ (Paper~III, Theorem~\xref{paper3}{thm:d4}), so the metric
...
Beta-function Gram matrix of Part~0~\cite{paper0} (Gram-as-Beta theorem).
\end{remark}
...
VEV $v$. \emph{Partially resolved} by Paper~IVb, Remark~\xref{paper4b}{rem:v-closure}: the factor
...
\bibitem{paper0} [Author], \extlink{\cascadebase/cascade-series-part0.pdf}{\textit{The Cascade Series --- Part~0: Scale Variance from Orthogonality}}, March 2026.

\bibitem{paper1} [Author], \extlink{\cascadebase/cascade-series-part1.pdf}{\textit{The Cascade Series --- Part~I: The Cosmological Constant from the Observer's Frame}}, March 2026.

\bibitem{paper2} [Author], \extlink{\cascadebase/cascade-series-part2.pdf}{\textit{The Cascade Series --- Part~II: Quantum Mechanics from the Cascade}}, March 2026.

\bibitem{paper3} [Author], \extlink{\cascadebase/cascade-series-part3.pdf}{\textit{The Cascade Series --- Part~III: General Relativity from the Cascade}}, March 2026.

\bibitem{paper23} [Author], \extlink{\cascadebase/cascade-series-part2-equals-3.pdf}{\textit{The Cascade Series --- Part II\,=\,III: Quantum Gravity without Quantising Gravity}}, March 2026.

\bibitem{paper4a} [Author], \extlink{\cascadebase/cascade-series-part4a.pdf}{\textit{The Cascade Series --- Part IVa: Standard Model from the Cascade}}, March 2026.

\bibitem{paper4b} [Author], \extlink{\cascadebase/cascade-series-part4b.pdf}{\textit{The Cascade Series --- Part IVb: Masses, Couplings, and Precision Predictions}}, March 2026.

\bibitem{paper5} [Author], \extlink{\cascadebase/cascade-series-part5.pdf}{\textit{The Cascade Series --- Part V: Cosmology from the Cascade}}, March 2026.
