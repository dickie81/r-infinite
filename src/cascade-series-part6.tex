...
\usepackage{xr-hyper}
\externaldocument[paper0:]{cascade-series-part0}[cascade-series-part0.pdf]
\externaldocument[paper1:]{cascade-series-part1}[cascade-series-part1.pdf]
\externaldocument[paper2:]{cascade-series-part2}[cascade-series-part2.pdf]
\externaldocument[paper23:]{cascade-series-part2-equals-3}[cascade-series-part2-equals-3.pdf]
...
\externaldocument[paper5:]{cascade-series-part5}[cascade-series-part5.pdf]
...
\bibitem{paper0} [Author], \hyperref[paper0:paperdoc]{\textit{The Cascade Series --- Part~0: Scale Variance from Orthogonality}}, March 2026.

\bibitem{paper1} [Author], \hyperref[paper1:paperdoc]{\textit{The Cascade Series --- Part~I: The Cosmological Constant from the Observer's Frame}}, March 2026.

\bibitem{paper2} [Author], \hyperref[paper2:paperdoc]{\textit{The Cascade Series --- Part~II: Quantum Mechanics from the Cascade}}, March 2026.

\bibitem{paper3} [Author], \hyperref[paper3:paperdoc]{\textit{The Cascade Series --- Part~III: General Relativity from the Cascade}}, March 2026.

\bibitem{paper23} [Author], \hyperref[paper23:paperdoc]{\textit{The Cascade Series --- Part II\,=\,III: Quantum Gravity without Quantising Gravity}}, March 2026.

\bibitem{paper4a} [Author], \hyperref[paper4a:paperdoc]{\textit{The Cascade Series --- Part IVa: Standard Model from the Cascade}}, March 2026.

\bibitem{paper4b} [Author], \hyperref[paper4b:paperdoc]{\textit{The Cascade Series --- Part IVb: Masses, Couplings, and Precision Predictions}}, March 2026.

\bibitem{paper5} [Author], \hyperref[paper5:paperdoc]{\textit{The Cascade Series --- Part V: Cosmology from the Cascade}}, March 2026.
