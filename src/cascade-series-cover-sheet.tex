...
Ultraviolet divergences hit a natural floor at $\Omega_{217}$. The Big Bang is
the asymptotic upper edge of the descent we are inside, as unreachable going
backward as the horizon is going forward.
...
against an unbounded denominator. The ``forced direction'' of the thought
experiment, the cascade's slicing direction (Part~II), and the cosmic-time
parameter (Part~V) are three vocabularies for this one rate.
