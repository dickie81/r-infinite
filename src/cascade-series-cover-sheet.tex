...
descent-dependent quantities carry uniformly negative deviations; geometric quantities
carry positive deviations. The Part~0 Supplement derives a first-order correction ---
a sum of Beta function ratios with no free parameters --- that reduces the descent
deviations from $\sim\!2\%$ to sub-$1\%$: $\alpha_s$ ($-1.7\%\to -0.5\%$),
$m_\tau$ ($-1.2\%\to -0.1\%$), $m_\tau/m_\mu$ ($-1.7\%\to -0.8\%$).
A second-order observable-dependent correction remains open. Falsification requires
