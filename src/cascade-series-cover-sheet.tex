...
Dirac spinor ($d\bmod 8=5$) for fermions, Adams vector fields for gauge
...
pattern, and one Higgs doublet---plus neutrino masses at the sub-eV scale
(from the suppressed fourth Bott layer at $d=29$, Part~IVb). It predicts that
