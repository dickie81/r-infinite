...
Theorem~\ref{thm:U1-gauge-forced} (\S7.4), the cascade's actual Born
...
structure of \S7.4 and Remark~\ref{rem:U1-gauge-Born}.
\end{remark}
...
Theorem~\ref{thm:U1-gauge-forced} (\S7.4) closes the question:
...
Theorem~\ref{thm:U1-gauge-forced} (\S7.4), the cascade's Born rule is
