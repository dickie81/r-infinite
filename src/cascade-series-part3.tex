...
and is retracted in Paper~V, Section~\xref{paper5}{sec:hubble-constant} (``Why the observer bridge and
...
\begin{itemize}[nosep]
\item The cascade does not \emph{avoid} Wick rotation; it \emph{motivates} it. Claims to the contrary in earlier drafts (and in this paper's abstract before revision, Paper~V, Section~\xref{paper5}{sec:hubble-constant}'s retracted framing, etc.) are retracted in favour of the honest statement.
...
would come from the discrete cascade-correction family of Paper~IVb, Section~\xref{paper4b}{sec:correction-family} evaluated with
...
\bibitem{paper4b} {[Author]}, \extlink{\cascadebase/cascade-series-part4b.pdf}{\textit{The Standard Model from the Cascade: Part IVb---Masses, Couplings, and Precision Predictions from the Geometric-Topological Factorization}}, March 2026.
