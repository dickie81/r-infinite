...
$S = A/4$ at $d = 4$, and the Hawking temperature $T = 1/(8\pi M)$ follows
from Birkhoff's theorem with no semiclassical input. Remaining open questions
(thermal spectrum, Page curve, Kerr/RN entropy) are listed there.
