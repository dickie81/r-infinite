...
\bibitem{paper0pre} {[Author]}, \hyperref[paper0pre:paperdoc]{\textit{The Cascade Series --- Prelude: Why Nothing Has Structure}}, March 2026.

\bibitem{paper1} {[Author]}, \hyperref[paper1:paperdoc]{\textit{Scale Variance from Orthogonality: How the Unit Ball Generates $10^{120}$ Orders of Magnitude}}, March 2026.

\bibitem{paper2} {[Author]}, \hyperref[paper2:paperdoc]{\textit{Quantum Mechanics from the Cascade: Effective Theory of a 4-Dimensional Observer in the Sphere-Area Geometry}}, March 2026.

\bibitem{paper4a} {[Author]}, \hyperref[paper4a:paperdoc]{\textit{The Standard Model from the Cascade: Part IVa---Gauge Group, Symmetry Breaking, and Three Generations from Bott Periodicity and Hairy Ball Zeros}}, March 2026.

\bibitem{paper5} {[Author]}, \hyperref[paper5:paperdoc]{\textit{The Cascade Series --- Part V: Cosmology from the Cascade: $\Lambda$CDM Parameters, the Hubble Constant, and the DESI BAO Observations}}, March 2026.
