...
\externaldocument[paper5:]{cascade-series-part5}
...
\bibitem{paper0pre} {[Author]}, \href{\cascadebase/cascade-series-prelude.pdf}{\textit{The Cascade Series --- Prelude: Why Nothing Has Structure}}, March 2026.

\bibitem{paper1} {[Author]}, \href{\cascadebase/cascade-series-part0.pdf}{\textit{Scale Variance from Orthogonality: How the Unit Ball Generates $10^{120}$ Orders of Magnitude}}, March 2026.

\bibitem{paper2} {[Author]}, \href{\cascadebase/cascade-series-part2.pdf}{\textit{Quantum Mechanics from the Cascade: Effective Theory of a 4-Dimensional Observer in the Sphere-Area Geometry}}, March 2026.

\bibitem{paper4a} {[Author]}, \href{\cascadebase/cascade-series-part4a.pdf}{\textit{The Standard Model from the Cascade: Part IVa---Gauge Group, Symmetry Breaking, and Three Generations from Bott Periodicity and Hairy Ball Zeros}}, March 2026.

\bibitem{paper5} {[Author]}, \href{\cascadebase/cascade-series-part5.pdf}{\textit{The Cascade Series --- Part V: Cosmology from the Cascade: $\Lambda$CDM Parameters, the Hubble Constant, and the DESI BAO Observations}}, March 2026.
