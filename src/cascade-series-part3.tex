...
Definition~2.2, clause~(i): parameter economy).
\end{itemize}
...
background fact. Item (v) is the austerity principle declared in the
Prelude (Definition~2.2) as a meta-mathematical commitment of the
series.
