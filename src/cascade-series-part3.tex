...
\begin{abstract}
The sphere-area cascade [1] derives a geometric invariant $I = 1.0989 \times 10^{-120}$
...
By [1], Theorem 9.2:
\[
I = \frac{9\,\Omega_{19}\,\Omega_{217}}{\pi^2} = 1.0989 \times 10^{-120}.
\]
...
would come from the discrete cascade-correction family of Paper~IVb, Section~\xref{part4b}{sec:correction-family} evaluated with
...
\bibitem{prelude} {[Author]}, \extlink{\cascadebase/cascade-series-prelude.pdf}{\textit{The Cascade Series --- Prelude: Why Nothing Has Structure}}, March 2026.

\bibitem{part0} {[Author]}, \extlink{\cascadebase/cascade-series-part0.pdf}{\textit{Scale Variance from Orthogonality: How the Unit Ball Generates $10^{120}$ Orders of Magnitude}}, March 2026.

\bibitem{part2} {[Author]}, \extlink{\cascadebase/cascade-series-part2.pdf}{\textit{Quantum Mechanics from the Cascade: Effective Theory of a 4-Dimensional Observer in the Sphere-Area Geometry}}, March 2026.

\bibitem{part4a} {[Author]}, \extlink{\cascadebase/cascade-series-part4a.pdf}{\textit{The Standard Model from the Cascade: Part IVa---Gauge Group, Symmetry Breaking, and Three Generations from Bott Periodicity and Hairy Ball Zeros}}, March 2026.
\bibitem{part4b} {[Author]}, \extlink{\cascadebase/cascade-series-part4b.pdf}{\textit{The Standard Model from the Cascade: Part IVb---Masses, Couplings, and Precision Predictions from the Geometric-Topological Factorization}}, March 2026.

\bibitem{part5} {[Author]}, \extlink{\cascadebase/cascade-series-part5.pdf}{\textit{The Cascade Series --- Part V: Cosmology from the Cascade: $\Lambda$CDM Parameters, the Hubble Constant, and the DESI BAO Observations}}, March 2026.
