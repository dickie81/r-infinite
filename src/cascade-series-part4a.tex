...
\usepackage{xr-hyper}
\externaldocument[paperI:]{cascade-series-part0}
\externaldocument[paperII:]{cascade-series-part2}
\externaldocument[paperIII:]{cascade-series-part3}
\externaldocument[paperIVb:]{cascade-series-part4b}
...
\bibitem{paperI} [Author], \href{\cascadebase/cascade-series-part0.pdf}{\emph{Scale Variance from Orthogonality: How the Unit Ball
Generates $10^{120}$ Orders of Magnitude}}, March 2026.
\bibitem{paperII} [Author], \href{\cascadebase/cascade-series-part2.pdf}{\emph{Quantum Mechanics from the Cascade: Effective Theory of
a 4-Dimensional Observer in the Sphere-Area Geometry}}, March 2026.
\bibitem{paperIII} [Author], \href{\cascadebase/cascade-series-part3.pdf}{\emph{General Relativity from the Cascade: Lovelock Uniqueness
and the Cosmological Constant of a 4-Dimensional Observer}}, March 2026.
\bibitem{paperIVb} [Author], \href{\cascadebase/cascade-series-part4b.pdf}{\emph{The Standard Model from the Cascade: Part IVb---Masses,
