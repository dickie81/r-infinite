...
The cascade is not yet complete. Three structural-alternative
freedoms remain (cascade-internal, not observer-side):
\begin{enumerate}[label=(\alph*),nosep]
\item Multiplicity matching at $d=13$ (cascade Route~(i): 14
doublets $+$ 14 singlets vs SM's 12 + 21 across 3 generations);
