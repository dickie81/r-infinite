...
This narrows the Y-spectrum gap precisely: it is downstream of one
structurally-specific open question (path-tensor consistency at the
gauge window), not three. A productive attack on the Y-spectrum
should identify path-tensor consistency conditions on the multi-layer
gauge action and check whether they reproduce the four anomaly-cancellation
equations cascade-natively.
