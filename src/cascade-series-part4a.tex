...
Part~IVb~\cite{paperIVb} Remark on the cascade-native gauge-coupled
fermion action ($\mathit{rem{:}fermion\text{-}gauge\text{-}coupling\text{-}proposal}$)
for details.
\end{itemize}
...
hypercharge values at $d=14$ (see
Part~IVb~\cite{paperIVb}~$\mathit{oq{:}y\text{-}sector\text{-}fundamental}$
for the open structural extension); see CLAUDE.md ``Known
Quantitative Issues'' for the broader
...
\item Sector-fundamental U(1)$_Y$ uniqueness theorem (Part~IVb's
$\mathit{oq{:}y\text{-}sector\text{-}fundamental}$);
