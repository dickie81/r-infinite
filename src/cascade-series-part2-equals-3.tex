...
\noindent(The table's section pointers were re-synchronised with the
current sectioning: they had drifted by one for every row from
``Mutual consistency'' onward after the Dirac Descent section's
insertion --- external review round 73.)
