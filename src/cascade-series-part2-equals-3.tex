...
\xrhyperdoc{paper6}{cascade-series-part6}
...
(Paper~II, Theorem~\xref{paper2}{thm:propagator}), and
\item the source of Lorentzian signature: oscillatory character requires
$g_{tt} < 0$ (Paper~III, Theorem~\xref{paper3}{thm:lorentzian}).
\end{enumerate}
\end{theorem}
...
(Paper~III~\cite{paper3}, Lemma~\xref{paper3}{lem:cascade-spinor-id}), the
...
$d_f$ (Paper~IVb~\cite{paper4b}, Theorem~\xref{paper4b}{thm:obstruction});
...
By Paper~III's Lemma~\xref{paper3}{lem:cascade-spinor-id} together with
Theorem~\xref{paper3}{thm:d4}, the cascade Hilbert space $\mathcal{H}$ at
...
Paper~IVb's Theorem~\xref{paper4b}{thm:obstruction} and the Berezin partition
...
per Lemma~\xref{paper3}{lem:cascade-spinor-id}), the cascade fermion field
is a section
\[
...
By Lemma~\xref{paper3}{lem:cascade-spinor-id}, the cascade Hilbert space
...
Remark~\xref{paper4b}{rem:berezin-partition-derivation}) equals the
...
(Paper~IVb~\cite{paper4b}, Section~\xref{paper4b}{sec:fermion-action}, with
...
(Paper~IVb~\cite{paper4b},
Theorem~\xref{paper4b}{thm:obstruction}) and the Hamiltonian-form Dirac
...
(Lemma~\xref{paper3}{lem:cascade-spinor-id}), the spatial derivatives
...
Lemma~\xref{paper3}{lem:cascade-spinor-id}). This is the same posture
as Schur's lemma in Paper~III's
Lemma~\xref{paper3}{lem:cascade-spinor-id}, Gleason's theorem in
...
Definition~\xref{paper6}{def:tower-time}).
...
(Paper~IVb~\cite{paper4b}, Remark~\xref{paper4b}{rem:action-uniqueness}),
...
Remark~\xref{paper4b}{rem:marginal-greens}).
...
Proposition~\xref{paper6}{prop:time-evolution}) governs the genuine
...
Remark~\xref{paper4b}{rem:action-uniqueness} from lattice covariance;
...
Lemma~\xref{paper3}{lem:cascade-spinor-id}, and the same posture
...
cascade forces $d = 4$ (Paper~III, Section~\xref{paper3}{sec:d-equals-4}) precisely where both
...
(Lorentzian cross-section radius, Paper~III, Theorem~\xref{paper3}{rem:sp-19-inputs}).
...
(Paper~0, Theorem~\xref{paper0}{thm:boundary}~\cite{paper0}, \xref{paper0}{thm:boundary}):
$\Omega_{d-1}/V_d = d$, hence $V_d = \Omega_{d-1}/d$.

\emph{Step 2 (derived, cascade-content primitive).} By Paper~0, Corollary~\xref{paper0}{cor:primary}, sphere area is the unique independent
...
$V_d = \Omega_{d-1}/d$ (Paper~0, Theorem~\xref{paper0}{thm:boundary}~\cite{paper0}). A Gamma-function
identity; no assumption.
\item \emph{Derived as a cascade primitive.} Content~$\equiv$~area and
volumes are derived: Paper~0, Corollary~\xref{paper0}{cor:primary} (\xref{paper0}{cor:primary}).
...
Corollary~3.2 of Paper~0 (\xref{paper0}{cor:primary}): sphere area is the only
...
hierarchy (Paper~I, Theorem~\xref{paper0}{thm:hierarchy}), seen from the other side: $\Lambda \sim
...
which is any $d\geq 1$ (Paper~0, Theorem~\xref{paper0}{thm:boundary}). It is not restricted to the
...
Corollary~\xref{paper0}{cor:primary}. The remaining step---that $S = A/d$ holds for any cascade
...
(Paper~II, Lemma~\xref{paper2}{lem:gaussian}); (ii)~the decoherence factor
$D = \exp(-D x^2/4R_{\rm eff}^2)$ is Gaussian (Paper~II, Theorem~\xref{paper2}{thm:reff}); (iii)~by the Araki--Woods theorem, Gaussian
...
graviton particles (Paper~III, Section~\xref{paper3}{sec:no-gravitons}). Computing the effective
...
\bibitem{paper0} RTAC, \extlink{\cascadebase/cascade-series-part0.pdf}{\textit{The Cascade Series~--- Part~0: The
Gamma-Function Structure of the Cascade}}, March 2026.

\bibitem{paper1} RTAC, \extlink{\cascadebase/cascade-series-part1.pdf}{\textit{The Cascade Series~--- Part~I: Scale Variance
from Orthogonality}}, March 2026.

\bibitem{paper2} RTAC, \extlink{\cascadebase/cascade-series-part2.pdf}{\textit{The Cascade Series~--- Part~II: Quantum
Mechanics from the Cascade}}, March 2026.

\bibitem{paper3} RTAC, \extlink{\cascadebase/cascade-series-part3.pdf}{\textit{The Cascade Series~--- Part~III: General
Relativity from the Cascade}}, March 2026.

\bibitem{paper4a} RTAC, \extlink{\cascadebase/cascade-series-part4a.pdf}{\textit{The Cascade Series~--- Part~IVa:
Standard Model from the Cascade --- Gauge Group, Symmetry Breaking,
and Three Generations}}, March 2026.

\bibitem{paper4b} RTAC, \extlink{\cascadebase/cascade-series-part4b.pdf}{\textit{The Cascade Series~--- Part~IVb:
Masses, Couplings, and Precision Predictions from the
Geometric-Topological Factorization}}, March 2026.

\bibitem{paper6} RTAC, \extlink{\cascadebase/cascade-series-part6.pdf}{\textit{The Cascade Series~--- Part~VI:
