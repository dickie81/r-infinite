...
\bibitem{paper0} RTAC, \href{cascade-series-part0.pdf}{\textit{The Cascade Series~--- Part~0: The
Gamma-Function Structure of the Cascade}}, March 2026.

\bibitem{paper1} RTAC, \href{cascade-series-part1.pdf}{\textit{The Cascade Series~--- Part~I: Scale Variance
from Orthogonality}}, March 2026.

\bibitem{paper2} RTAC, \href{cascade-series-part2.pdf}{\textit{The Cascade Series~--- Part~II: Quantum
Mechanics from the Cascade}}, March 2026.

\bibitem{paper3} RTAC, \href{cascade-series-part3.pdf}{\textit{The Cascade Series~--- Part~III: General
Relativity from the Cascade}}, March 2026.

\bibitem{paper4a} RTAC, \href{cascade-series-part4a.pdf}{\textit{The Cascade Series~--- Part~IVa:
Standard Model from the Cascade --- Gauge Group, Symmetry Breaking,
and Three Generations}}, March 2026.

\bibitem{paper4b} RTAC, \href{cascade-series-part4b.pdf}{\textit{The Cascade Series~--- Part~IVb:
Masses, Couplings, and Precision Predictions from the
Geometric-Topological Factorization}}, March 2026.

\bibitem{paper6} RTAC, \href{cascade-series-part6.pdf}{\textit{The Cascade Series~--- Part~VI:
