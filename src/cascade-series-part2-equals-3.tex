...
\externaldocument[paper6:]{cascade-series-part6}[cascade-series-part6.pdf]
...
\bibitem{paper0} RTAC, \hyperref[paper0:paperdoc]{\textit{The Cascade Series~--- Part~0: The
Gamma-Function Structure of the Cascade}}, March 2026.

\bibitem{paper1} RTAC, \hyperref[paper1:paperdoc]{\textit{The Cascade Series~--- Part~I: Scale Variance
from Orthogonality}}, March 2026.

\bibitem{paper2} RTAC, \hyperref[paper2:paperdoc]{\textit{The Cascade Series~--- Part~II: Quantum
Mechanics from the Cascade}}, March 2026.

\bibitem{paper3} RTAC, \hyperref[paper3:paperdoc]{\textit{The Cascade Series~--- Part~III: General
Relativity from the Cascade}}, March 2026.

\bibitem{paper4a} RTAC, \hyperref[paper4a:paperdoc]{\textit{The Cascade Series~--- Part~IVa:
Standard Model from the Cascade --- Gauge Group, Symmetry Breaking,
and Three Generations}}, March 2026.

\bibitem{paper4b} RTAC, \hyperref[paper4b:paperdoc]{\textit{The Cascade Series~--- Part~IVb:
Masses, Couplings, and Precision Predictions from the
Geometric-Topological Factorization}}, March 2026.

\bibitem{paper6} RTAC, \hyperref[paper6:paperdoc]{\textit{The Cascade Series~--- Part~VI:
