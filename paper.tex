...
\item \textbf{Global Variational Principle} -- The regulator is promoted to a uniform term in the Einstein--Hilbert action integrated over the infinite tower (Sec.~1.4).
