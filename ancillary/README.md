...
### Contents
- `GL_shooting_stub.py` — SciPy-based shooting solver for the master radial ODE (generalized Gregory–Laflamme + regulator δV_λ). Reproduces the D=5 benchmark and permits exploration of the D→4 limit.
...
```bash
cd ancillary
python GL_shooting_stub.py --D 5.0 --lambda_reg -0.083333